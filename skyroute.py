...
stations_under_construction = []  # Here you can insert any stations that are closed
...
def new_route(start_point=None, end_point=None):
    ...
    if shortest_route:
        ...
        print("Unfortunatly, there is currently no path between {0} and {1} due to maintenance.".format(start_point,
                                                                                                        end_point))
